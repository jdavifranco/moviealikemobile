...
AppTypographyScheme largeTypographyScheme = const AppTypographyScheme(
  heading1: TextStyle(
    color: AppColors.textPrimary,
    fontWeight: FontWeight.bold,
    fontFamily: FontFamilies.montserrat,
    fontSize: 40.0, // Adjusted from 60.0
  ),
  heading2: TextStyle(
    color: AppColors.textPrimary,
    fontWeight: FontWeight.normal,
    fontFamily: FontFamilies.montserrat,
    fontSize: 36.0, // Adjusted from 48.0
  ),
  heading3: TextStyle(
    color: AppColors.textPrimary,
    fontWeight: FontWeight.normal,
    fontFamily: FontFamilies.montserrat,
    fontSize: 32.0, // Adjusted from 40.0
  ),
  heading4: TextStyle(
    color: AppColors.textPrimary,
    fontWeight: FontWeight.normal,
    fontFamily: FontFamilies.montserrat,
    fontSize: 28.0, // Adjusted from 32.0
  ),
  heading5: TextStyle(
    color: AppColors.textPrimary,
    fontWeight: FontWeight.bold,
    fontFamily: FontFamilies.montserrat,
    fontSize: 24.0, // Adjusted from 24.0
  ),
  heading6: TextStyle(
    color: AppColors.textPrimary,
    fontWeight: FontWeight.bold,
  ...
  body2: TextStyle(
    color: AppColors.textSecondary,
    fontWeight: FontWeight.bold,
    fontSize: 14.0, // Adjusted from 12.0
  ),
  body3: TextStyle(
    color: AppColors.textSecondary,
    fontWeight: FontWeight.normal,
