...
abstract class MovieRepository {
  ...
  Future<Result<List<Movie>, RequestError>> getMoviesWithGenres(List<int> genreIds);
  Future<Result<List<Movie>, RequestError>> getMoviesWithKeywords(List<int> keywords, List<int> genreIds);
  ...
  Future<Result<List<CastMember>, RequestError>> getCastCrewMembers(int movieId);
  Future<Result<List<MovieVideo>, RequestError>> getMovieYoutubeVideos(int movieId);
  Future<Result<List<MovieKeyword>, RequestError>> getMovieKeywords(int movieId);
}
